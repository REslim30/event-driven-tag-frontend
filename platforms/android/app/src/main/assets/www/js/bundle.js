...
(function () {
  var t = {
    ...
    704: function _(t, e) {
      !function (t) {
        ...
        e.encode = function (e) {
          ...
          for (n = 0; n < c; n += 4) {
            r = t.indexOf(e[n]), o = t.indexOf(e[n + 1]), i = t.indexOf(e[n + 2]), s = t.indexOf(e[n + 3]), u[p++] = r << 2 | o >> 4, u[p++] = (15 & o) << 4 | i >> 2, u[p++] = (3 & i) << 6 | 63 & s;
          }
    ...
    983: function _(t, e, n) {
      t.exports = n(192), t.exports.parser = n(455);
    },
    192: function _(t, e, n) {
      var r = n(352),
          o = n(767),
          i = n(802)("engine.io-client:socket"),
          s = n(355),
          a = n(455),
          c = n(187),
          p = n(830);
      ...
      t.exports = h, h.priorWebsocketSuccess = !1, o(h.prototype), h.protocol = a.protocol, h.Socket = h, h.Transport = n(496), h.transports = n(352), h.parser = n(455), h.prototype.createTransport = function (t) {
        ...
        function f() {
          e.removeListener("open", o), e.removeListener("error", a), e.removeListener("close", c), r.removeListener("close", p), r.removeListener("upgrading", u);
        }

        h.priorWebsocketSuccess = !1, e.once("open", o), e.once("error", a), e.once("close", c), this.once("close", p), this.once("upgrading", u), e.open();
    ...
    416: function _(t, e, n) {
      var r = n(777),
          o = n(15),
          i = n(767),
          s = n(861),
          a = n(802)("engine.io-client:polling-xhr"),
          c = n(549);
      ...
      t.exports = h, t.exports.Request = u, s(h, o), h.prototype.supportsBinary = !0, h.prototype.request = function (t) {
        ...
        if (void 0 !== this.xhr && null !== this.xhr) {
          if (this.hasXDR() ? this.xhr.onload = this.xhr.onerror = p : this.xhr.onreadystatechange = p, t) try {
            this.xhr.abort();
          } catch (t) {}
        ...
        this.cleanup();
      }, u.requestsCount = 0, u.requests = {}, "undefined" != typeof document && ("function" == typeof attachEvent ? attachEvent("onunload", f) : "function" == typeof addEventListener && addEventListener("onpagehide" in c ? "pagehide" : "unload", f, !1));
    },
    15: function _(t, e, n) {
      var r = n(496),
          o = n(830),
          ...
          s = n(861),
          a = n(281),
          c = n(802)("engine.io-client:polling");
      t.exports = h;
      var p = null != new (n(777))({
        xdomain: !1
      }).responseType;
      ...
      s(h, r), h.prototype.name = "polling", h.prototype.doOpen = function () {
        ...
        var e = this;
        c("polling got data %s", t), i.decodePayload(t, this.socket.binaryType, function (t, n, r) {
    ...
    442: function _(t, e, n) {
      var r,
          ...
          c = n(861),
          p = n(281),
          h = n(802)("engine.io-client:websocket");
      ...
      function f(t) {
        t && t.forceBase64 && (this.supportsBinary = !1), this.perMessageDeflate = t.perMessageDeflate, this.usingBrowserWebSocket = r && !t.forceNode, this.protocols = t.protocols, this.usingBrowserWebSocket || (u = o), i.call(this, t);
      }

      t.exports = f, c(f, i), f.prototype.name = "websocket", f.prototype.supportsBinary = !0, f.prototype.doOpen = function () {
        if (this.check()) {
          var t = this.uri(),
              e = this.protocols,
              n = {};
        ...
        for (var n = t.length, r = 0, o = n; r < o; r++) {
          !function (t) {
            s.encodePacket(t, e.supportsBinary, function (r) {
    ...
    802: function _(t, e, n) {
      ...
      (e = t.exports = n(616)).log = function () {
    ...
    616: function _(t, e, n) {
      function r(t) {
        ...
        function r() {
          if (r.enabled) {
            ...
            var p = r.log || e.log || console.log.bind(console);
            p.apply(t, s);
          }
        }
      ...
      (e = t.exports = r.debug = r["default"] = r).coerce = function (t) {
        ...
        return !1;
      }, e.humanize = n(824), e.instances = [], e.names = [], e.skips = [], e.formatters = {};
    },
    455: function _(t, e, n) {
      var r,
          o = n(990),
          i = n(466),
          s = n(718),
          a = n(906),
          c = n(414);
      "undefined" != typeof ArrayBuffer && (r = n(704));
      ...
      e.encodePacket = function (t, n, r, o) {
        ...
        if (void 0 !== y && i instanceof y) return function (t, n, r) {
          ...
          return o[0] = f[t.type], r(new y([o.buffer, t.data]));
        }(t, n, o);
        ...
        var o = i(t);
        return n && o ? y && !u ? e.encodePayloadAsBlob(t, r) : e.encodePayloadAsArrayBuffer(t, r) : t.length ? void g(t, function (t, r) {
        ...
        g(t, function (t, n) {
          ...
          return e.forEach(function (t) {
            ...
            for (o[i++] = 255, r = new Uint8Array(n), s = 0; s < r.length; s++) {
              o[i++] = r[s];
            }
          }), n(o.buffer);
        });
        ...
        for (var o = t, i = []; o.byteLength > 0;) {
          for (var a = new Uint8Array(o), c = 0 === a[0], p = "", h = 1; 255 !== a[h]; h++) {
            if (p.length > 310) return r(d, 0, 1);
            p += a[h];
          }

          o = s(o, 2 + p.length), p = parseInt(p);
          var u = s(o, 0, p);
          if (c) try {
    ...
    414: function _(t) {
      ...
      function h(t) {
        ...
        if (192 == (224 & o)) {
          if ((i = (31 & o) << 6 | p()) >= 128) return i;
          throw Error("Invalid continuation byte");
        }

        if (224 == (240 & o)) {
          if ((i = (15 & o) << 12 | p() << 6 | p()) >= 2048) return s(i, t) ? i : 65533;
          throw Error("Invalid continuation byte");
        }

        if (240 == (248 & o) && (i = (7 & o) << 18 | p() << 12 | p() << 6 | p()) >= 65536 && i <= 1114111) return i;
      ...
      t.exports = {
        ...
        encode: function encode(t, e) {
          for (var n = !1 !== (e = e || {}).strict, r = i(t), o = r.length, s = -1, a = ""; ++s < o;) {
            a += c(r[s], n);
          }

          return a;
        },
        decode: function decode(t, s) {
          var a = !1 !== (s = s || {}).strict;
    ...
    824: function _(t) {
      ...
      t.exports = function (t, s) {
        ...
        if ("number" === c && !1 === isNaN(t)) return s["long"] ? i(a = t, o, "day") || i(a, r, "hour") || i(a, n, "minute") || i(a, e, "second") || a + " ms" : function (t) {
          return t >= o ? Math.round(t / o) + "d" : t >= r ? Math.round(t / r) + "h" : t >= n ? Math.round(t / n) + "m" : t >= e ? Math.round(t / e) + "s" : t + "ms";
        }(t);
    ...
    187: function _(t) {
      ...
      t.exports = function (t) {
        ...
        for (var c, p, h = e.exec(t || ""), u = {}, f = 14; f--;) {
          u[n[f]] = h[f] || "";
        }

        return -1 != s && -1 != a && (u.source = i, u.host = u.host.substring(1, u.host.length - 1).replace(/;/g, ":"), u.authority = u.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), u.ipv6uri = !0), u.pathNames = (r = u.path, o = r.replace(/\/{2,9}/g, "/").split("/"), "/" != r.substr(0, 1) && 0 !== r.length || o.splice(0, 1), "/" == r.substr(r.length - 1, 1) && o.splice(o.length - 1, 1), o), u.queryKey = (c = u.query, p = {}, c.replace(/(?:^|&)([^&=]*)=?([^&]*)/g, function (t, e, n) {
          e && (p[e] = n);
        }), p), u;
      };
    },
    809: function _(t, e, n) {
      var r = n(678),
          o = n(113),
          i = n(739),
          s = n(669)("socket.io-client");
      t.exports = e = c;
      var a = e.managers = {};
      ...
      function c(t, e) {
        ...
        var n,
            ...
            h = o.path,
            u = a[p] && h in a[p].nsps;
        return e.forceNew || e["force new connection"] || !1 === e.multiplex || u ? (s("ignoring socket cache for %s", c), n = i(c, e)) : (a[p] || (s("new io instance for %s", c), a[p] = i(c, e)), n = a[p]), o.query && !e.query && (e.query = o.query), n.socket(o.path, e);
      }

      e.protocol = o.protocol, e.connect = c, e.Manager = n(739), e.Socket = n(584);
    },
    739: function _(t, e, n) {
      var r = n(983),
          ...
          a = n(464),
          c = n(77),
          p = n(669)("socket.io-client:manager"),
          h = n(355),
          u = n(10),
      ...
      t.exports = l, l.prototype.emitAll = function () {
        ...
        var i = a(n, "open", function () {
          ...
          if (p("connect_error"), o.cleanup(), o.readyState = "closed", o.emitAll("connect_error", e), t) {
        ...
        if (!1 !== this._timeout) {
          var c = this._timeout;
          p("connect attempt will timeout after %d", c), 0 === c && i.destroy();
          var h = setTimeout(function () {
            p("connect attempt timed out after %d", c), i.destroy(), n.close(), n.emit("error", "timeout"), o.emitAll("connect_timeout", c);
          }, c);
          this.subs.push({
    ...
    584: function _(t, e, n) {
      var r = n(113),
          ...
          s = n(464),
          a = n(77),
          c = n(669)("socket.io-client:socket"),
          p = n(830),
          h = n(466);
      t.exports = l;
      var u = {
    ...
    669: function _(t, e, n) {
      ...
      (e = t.exports = n(350)).log = function () {
        return "object" == (typeof console === "undefined" ? "undefined" : _typeof(console)) && console.log && Function.prototype.apply.call(console.log, console, arguments);
      }, e.formatArgs = function (t) {
        var n = this.useColors;
    ...
    326: function _(t, e, n) {
      ...
      function p(t, e) {
        ...
        if (r(t)) for (var n = 0; n < t.length; n++) {
          t[n] = p(t[n], e);
      ...
      e.deconstructPacket = function (t) {
        ...
        return t.data = p(t.data, e), t.attachments = void 0, t;
        ...
        !function t(c, p, h) {
          ...
          if (s && c instanceof Blob || a && c instanceof File) {
            ...
            u.onload = function () {
              h ? h[p] = this.result : i = this.result, --n || e(i);
            }, u.readAsArrayBuffer(c);
          } else if (r(c)) for (var f = 0; f < c.length; f++) {
            t(c[f], f, c);
    ...
    113: function _(t, e, n) {
      ...
      c.prototype.encode = function (t, n) {
        ...
        if ("string" == typeof t) n = function (t) {
          ...
          if ("/" === t.charAt(n + 1)) for (o.nsp = ""; ++n && "," !== (c = t.charAt(n)) && (o.nsp += c, n !== t.length);) {
            ;
          } else o.nsp = "/";
          var a = t.charAt(n + 1);
    ...
    66: function _(t) {
      t.exports = function (t) {
        return e && Buffer.isBuffer(t) || n && (t instanceof ArrayBuffer || function (t) {
    ...
    618: function _(t, e, n) {
      ...
      (e = t.exports = n(968)).log = function () {
        return "object" == (typeof console === "undefined" ? "undefined" : _typeof(console)) && console.log && Function.prototype.apply.call(console.log, console, arguments);
      }, e.formatArgs = function (t) {
        var n = this.useColors;
  ...
  n.n = function (t) {
    ...
    var t = n(809)("http://192.168.1.28:3000");
    t.on("connect", function (t) {
      console.log(t);
    }), t.on("broadcast", function (t) {
